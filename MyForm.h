...
namespace NumMetLaba04 {
	...
	public:
		MyForm(void)
		{
			...
			pane1->XAxis->Title->Text = "Îñü x";
			pane1->YAxis->Title->Text = "Îñü u,v";
			pane1->Title->Text = "ãðàôèê òî÷íîãî è ÷èñëåííîãî ðåøåíèÿ";

			GraphPane^ pane2 = zedGraphControl2->GraphPane;
			pane2->XAxis->Title->Text = "Îñü x";
			pane2->YAxis->Title->Text = "Îñü u,v";
			pane2->Title->Text = "ãðàôèê òî÷íîãî è ÷èñëåííîãî ðåøåíèÿ";

			GraphPane^ pane3 = zedGraphControl3->GraphPane;
			pane3->XAxis->Title->Text = "Îñü x";
			pane3->YAxis->Title->Text = "Îñü v, v2";
			pane3->Title->Text = "ãðàôèê ÷èñëåííîãî è áîëåå òî÷íîãî ÷èñëåííîãî ðåøåíèÿ";

			GraphPane^ pane4 = zedGraphControl4->GraphPane;
			pane4->XAxis->Title->Text = "Îñü x";
			pane4->YAxis->Title->Text = "ïîãðåøíîñòü";
			pane4->Title->Text = "ïîãðåøíîñòü îò Õ";

			GraphPane^ pane5 = zedGraphControl5->GraphPane;
			pane5->XAxis->Title->Text = "Îñü x";
			pane5->YAxis->Title->Text = "ïîãðåøíîñòü";
			pane5->Title->Text = "ïîãðåøíîñòü îò Õ";
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Ìàêñèìàëüíîå îòêëîíåíèå\r\n\r\n äîñòèãàåòñÿ â òî÷êå:";
			// 
			// tabPage3
			// 
			...
			this->label9->Text = L"Ïðè ïåðåñ÷åòå çíà÷åíèé\r\n ñ ïîëîâèííûì øàãîì\r\n ìàêñèìàëüíàÿ ðàçíîñòü\r\n ïðèáëèæåííû"
				L"õ ðåøåíèé ñîñòàâèëà:\r\n\r\nè ñîîòâåòñòâóåò óçëó:";
			// 
			// MyForm
			// 
